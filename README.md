...
<img width="auto" height="346,5" alt="image" src="https://github.com/user-attachments/assets/23b8ffdf-71fb-40c4-8690-db612a0d03f6" />
...
| Key | Action |
| :--- | :--- |
| TAB | Search in Homebrew |
| V | Cycle views |
| SPACE | Select or deselect |
| ENTER | Finalize and run |
